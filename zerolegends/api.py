"""Handler for editting zero legends for bcsfe 2.7.2.3 api"""
from typing import Any

from BCSFE_Python_Discord.edits.levels import event_stages
from BCSFE_Python_Discord import user_input_handler
